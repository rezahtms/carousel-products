        ...
        <section className={cx('not-found-wrapper',
            ...
            <div className={cx('not-found-container', 'py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6')}>
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <Link to="/" className={cx('back','inline-flex text-white bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4')}>Back to Homepage</Link>
                </div>
            </div>
        </section>
    )
